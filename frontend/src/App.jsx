...
function App() {
  ...
  const [genre,setGenre] = useState(" ")
    const [myUrl, setMyUrl] = useState(`https://api.themoviedb.org/3/discover/movie?with_genre=${genre}&api_key=f365f4ddf79f3707857efed734c40500&language=fr&page=`);
  ...
  return (
    <div className="App">
      <h1>Movies</h1>
      <p>
        Filtres actuels : Par popularité</p>
      <Filter
